...
export function themeVars(
  ...
  return {
    ...
    '--glass':        mode === 'dark'
      ...
      : `rgba(255,255,255,${0.55 + glassOpacity})`,
    ...
    '--brand-soft':   mode === 'dark' ? `${accent}26` : `${accent}1A`,
    '--brand-glow':   `${accent}55`,
    ...
    '--shadow-glow':      `0 0 0 1px ${accent}73, 0 0 24px ${accent}59`,
    '--shadow-glow-soft': `0 0 32px ${accent}2E`,
  };
}
